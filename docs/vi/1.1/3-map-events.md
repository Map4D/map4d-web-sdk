...
## 1. Giới thiệu chung
  ...
  **1.16. polygonClick**
  - Được gọi khi click chuột trái vào polygon
  
  **1.17. circleClick**
  - Được gọi khi click chuột trái vào circle  
  
  **1.18. modeChanged**
  - Được gọi khi chuyển mode từ 2D sang 3D và ngược lại 
  
  **1.19. markerHover**
  - Được gọi khi rê chuột vào Marker
  
  **1.20. objectHover**
  - Được gọi khi rê chuột vào Object
  
  **1.21. polygonHover**
  - Được gọi khi rê chuột vào Polygon
  
  **1.22. polylineHover**
  - Được gọi khi rê chuột vào Polyline
  
  **1.23. circleHover**
  - Được gọi khi rê chuột vào Circle
  
  **1.24. longClick**
  - Được gọi khi giữ chuột trái trong 1 khoảng thời gian trên bản đồ 
  
  **1.25. markerLongClick**
  - Được gọi khi giữ chuột trái trong 1 khoảng thời gian trên marker
  
  **1.26. objectLongClick**
  - Được gọi khi giữ chuột trái trong 1 khoảng thời gian trên Object
  
  **1.27. polygonLongClick**
  - Được gọi khi giữ chuột trái trong 1 khoảng thời gian trên polygon
  
  **1.28. polylineLongClick**
  - Được gọi khi giữ chuột trái trong 1 khoảng thời gian trên polyline
  
  **1.29. circleLongClick**
  - Được gọi khi giữ chuột trái trong 1 khoảng thời gian trên circle
